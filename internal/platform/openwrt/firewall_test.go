...
func TestBuildNFTablesRules(t *testing.T) {
	...
	if mark, redirect := strings.Index(rules, "meta mark 0x10000 return"), strings.LastIndex(rules, "redirect to :12345"); mark < 0 || redirect < 0 || mark > redirect {
