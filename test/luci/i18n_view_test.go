...
func TestFastLaneViewsUseEnglishSourceAndCompleteRussianCatalog(t *testing.T) {
	...
	paths := []string{
		...
		filepath.Join(root, "luci-app-fastlane", "htdocs", "luci-static", "resources", "view", "fastlane", "vpn-20260907-menu-v22.js"),
		...
		filepath.Join(root, "luci-app-fastlane", "htdocs", "luci-static", "resources", "view", "fastlane", "settings-20260907-duration-v7.js"),
	}
