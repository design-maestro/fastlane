...
func TestPackageOpenWrtFallsBackToTarWhenBSDTarMissing(t *testing.T) {
	...
	writeFile(t, filepath.Join(repoDir, "luci-app-fastlane", "htdocs", "luci-static", "resources", "view", "fastlane", "vpn-20260910-menu-v23.js"), "'use strict';\n", 0o644)
	...
	writeFile(t, filepath.Join(repoDir, "luci-app-fastlane", "htdocs", "luci-static", "resources", "view", "fastlane", "settings-20260907-duration-v7.js"), "'use strict';\n", 0o644)
