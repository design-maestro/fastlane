...
func TestPackageOpenWrtFallsBackToTarWhenBSDTarMissing(t *testing.T) {
	...
	writeFile(t, filepath.Join(repoDir, "luci-app-fastlane", "htdocs", "luci-static", "resources", "view", "fastlane", "vpn-20260910-hide-keywords-v26.js"), "'use strict';\n", 0o644)
	...
	writeFile(t, filepath.Join(repoDir, "luci-app-fastlane", "htdocs", "luci-static", "resources", "view", "fastlane", "settings-20260910-hide-keywords-v8.js"), "'use strict';\n", 0o644)
	...
	for _, name := range []string{
		"vpn-20260910-hide-keywords-v26.js",
